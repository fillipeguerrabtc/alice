...
GPU_MEMORY_UTILIZATION_RESOLVED="$(resolve_env_value "0.36" "GPU_MEMORY_UTILIZATION" "LLM_GPU_MEMORY_UTILIZATION")"
...
PREFIX_CACHING_RESOLVED="$(resolve_env_value "true" "ENABLE_PREFIX_CACHING" "LLM_ENABLE_PREFIX_CACHING")"
