...
MAX_MODEL_LEN_VALUE="${LLM_MAX_MODEL_LEN:-${MAX_MODEL_LEN:-4096}}"
MAX_NUM_SEQS_VALUE="${LLM_MAX_NUM_SEQS:-${MAX_NUM_SEQS:-8}}"
MAX_BATCHED_TOKENS_VALUE="${LLM_MAX_NUM_BATCHED_TOKENS:-${MAX_NUM_BATCHED_TOKENS:-1024}}"
GPU_MEMORY_UTILIZATION_VALUE="${LLM_GPU_MEMORY_UTILIZATION:-${GPU_MEMORY_UTILIZATION:-0.34}}"
