...
*Deploy em Fases Sequenciais (23/12/2025): Deploy anterior tentava iniciar 44 containers simultaneamente com único `docker compose up`, sobrecarregando o sistema e causando falhas de timing/dependência. Corrigido para deploy em 7 fases sequenciais: (1) Pull imagens, (2) Infraestrutura base Alice, (3) Gateway Traefik, (4) Serviços Alice, (5) Infraestrutura ERPNext, (6) Init e Serviços ERPNext, (7) Observability. Cada fase aguarda containers ficarem healthy antes de prosseguir.*
