...
*Bug Fix ERPNext Configurator apps.txt (21/12/2025): erpnext-configurator falhava com "OSError: b'./apps.txt' Not Found" porque bench precisa de apps.txt além de common_site_config.json. Corrigido criando apps.txt com "frappe\nerpnext" antes de bench set-config. Apps.txt lista as apps instaladas no frappe-bench.*
