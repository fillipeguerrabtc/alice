...
> **Versão:** 3.21 - Cache pnpm fix (actions/cache SHA)
...
>
> **NOTA (12/12/2025):** Cache pnpm no deploy-prod: removida flag `cache: pnpm` do `actions/setup-node` (erro 400 intermitente) e adicionado cache explícito com `actions/cache@v3.3.2` pinado por SHA (`5c44214e5212b11e8f2ea3f1b6fe40950b9230a3`) usando store-dir fixo (`$HOME/.pnpm-store`) e chave baseada em OS + versão do pnpm + hash do `pnpm-lock.yaml`.
