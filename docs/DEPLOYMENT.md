...
| 9 | **RAG Service** | `alice-rag` | `apps/rag-service` | Retrieval-Augmented Generation com embeddings locais (multilingual-e5-base), busca semântica pgvector, processamento de documentos. | Node.js, pgvector, CLIP Service local |
