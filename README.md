...
|---|---------|-----------|-------|-----------|
| 5 | API Gateway | `alice-api-gateway` | 3000 | Roteamento interno, circuit breakers, health aggregation |
...
| 15 | Redis Cache | `erpnext-redis-cache` | Cache de sessões |
| 16 | Redis Queue | `erpnext-redis-queue` | Fila de jobs |
