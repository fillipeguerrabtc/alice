...
import { createTradingRiskGateService } from './trading-risk-gate.js';
...
const tradingRiskGateService = createTradingRiskGateService({
  getRiskConfig: (authContext: TradingAuthContext) => getRiskConfig(authContext),
});

export const { setTradingRiskGateMetricObserver, validateTradingAllowed } = tradingRiskGateService;
