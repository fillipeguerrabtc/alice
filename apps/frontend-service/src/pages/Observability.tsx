...
function QuickLinks({ urls }: { urls?: ObservabilityUrls }) {
  ...
  const links = [
    ...
    {
      name: 'Prometheus',
      url: urls?.prometheus?.external || 'https://metrics.yesyoudeserve.duckdns.org',
      icon: Gauge,
    ...
    {
      name: 'Jaeger',
      url: urls?.jaeger?.external || 'https://traces.yesyoudeserve.duckdns.org',
      icon: Network,
    ...
    {
      name: 'Langfuse',
      url: urls?.langfuse?.external || 'https://langfuse.yesyoudeserve.duckdns.org',
      icon: Brain,
