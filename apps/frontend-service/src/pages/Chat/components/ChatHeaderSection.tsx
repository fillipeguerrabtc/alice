...
export function ChatHeaderSection({
  ...
  return (
    <div className="safe-area-inset-top border-b border-border/60 bg-[linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--background)/0.94)_100%)] backdrop-blur supports-[backdrop-filter]:bg-background/78">
